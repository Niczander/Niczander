...
if($_SERVER['REQUEST_METHOD']==='POST'){
  ...
  if(strlen($username)<3||strlen($password)<4){
    $msg='Provide a valid username and a password of at least 4 characters.';
    ...
    <div class="row justify-content-center">
      <div class="col-md-5">
        <div class="card shadow-sm">
          <div class="card-header bg-navy text-white">Create Admin Account</div>
          <div class="card-body">
            ...
            <form method="post" autocomplete="off">
              ...
              <button class="btn btn-primary w-100" style="background:#0a2540;border-color:#0a2540">Create Account</button>
            </form>
